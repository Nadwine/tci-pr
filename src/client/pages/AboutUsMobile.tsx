    ...
    <div className="p-0 w-100">
      ...
      <div className="welcome-search justify-content-center">
        <div className="justify-content-center shadow-sm align-items-center" style={{ height: "210px", marginLeft: "0px" }}>
          ...
          <h1
            ...
            style={{ zIndex: +1, position: "relative", paddingTop: "60px", textAlign: "left", color: "white", WebkitTextStroke: "1px" }}
          >
      ...
      <div className="ps-3">
        ...
        <div className="mx-lg-5 text-secondary me-3" style={{ fontSize: "14px" }}>
          Introducing TCI Homebase, your premier partner in property management across the breathtaking landscape of the Turks and Caicos Islands! Nestled in
          the heart of Providenciales, our licensed company extends its reach to serve all the islands within this captivating archipelago.
        </div>
        <div className="mt-5">
          <h4 style={{ width: "20px" }}>
