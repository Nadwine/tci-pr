...
export const uploadNewPropertyDoc = async (req: Request, res: Response) => {
  const { propertyForRentId, documentType, date, attachExpense, description, expenseAmount, operation, category } = req.body;
